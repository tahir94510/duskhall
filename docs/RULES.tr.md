...
Hizmetkâr (Yeşil) x16: 3 farklı kart, 4 ila 8 adet.
...
Menüdeki isteğe bağlı bir Rehber, bu kitabı adım adım anlatır — hazırlık, ilk oyuncu çekilişi ve her turun Odak, Eylem ve Kapanış fazları. Masa birlikte ilerler: her adımda koltuk başına bir "hazır" göstergesi belirir ve herkes dokununca sonraki adıma geçilir. Rehber yalnızca önerir; oyunu asla kısıtlamaz. Oda sahibi (host), deste toplanıp karıştırılarak yeni bir oyun başlatmak için Macerayı başlat'ı kullanabilir (oyun başladıktan sonra aynı düğme Yeniden başlat olur); Desteyi sıfırla ise tüm kartları karışık tek desteye döndürür. Rehber çalışırken, küçük bir köşe göstergesi kimin sırasında olduğunu ve mevcut fazı gösterir. Bu kontroller yalnızca host'a aittir; Rehber'i herkes açıp gizleyebilir ve kendi adımlarını onaylayabilir.
