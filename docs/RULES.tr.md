...
**2–4 oyuncu · 30–60 dakika · 14 yaş ve üzeri**
...
· Mühür (Mor) ×16 — 4 farklı mühür, her birinden 4 adet.

· Büyü (Kızıl) ×24 — 5 farklı büyü, 2 ila 8 adet.

· Müdahale (Gök) ×16 — 3 farklı kart, 4 ila 8 adet.

· Hizmetkâr (Yeşil) ×16 — 3 farklı kart, 4 ila 8 adet.
...
DESTE (ortak) — ortadaki kapalı yığın. Bittiğinde Eter Dalgalanması tetiklenir (§9).
...
AŞAMA 2 — AKSİYON: Bu turda 2 HP'niz var (Kızıl Monolit ile 3–5; max 5). HP'leri aşağıdaki eylemler için, istediğiniz kombinasyonda harcayın. Kalan HP yanar; bir sonraki tura aktarılamaz.
...
AŞAMA 3 — KAPANIŞ: Önce aktif tüm Mühür efektleri devreye girer (Ölüçağıranın Gözü kartını şimdi alır). Sonra el limiti kontrol edilir; 7'ye iner. Kapanış tamamlandıktan sonra masanızda en az 3 Mühür varsa Yükseliş ilan edebilirsiniz (§10).
...
Zaman Çatlağı — istiflenir. Her kopya Odaklanma çekimine +1 ekler. (1=3, 2=4, 3=5, 4=6.)

Kızıl Monolit — istiflenir, üst sınırlıdır. Her kopya +1 HP ekler; toplam HP üst sınırı 5.

Ölüçağıranın Gözü — istiflenir. Her kopya Kapanış'ta Çöplükten 1 kart daha alır.

Hiçlik Örtüsü — İSTİFLENMEZ. Ek kopya avantaj sağlamaz.
...
Bir kart metni ile genel bir kural çelişiyor gibi göründüğünde, kart metni kazanır.
...
S. 2 Zaman Çatlağı masada, kaç kart çekerim? · C. 4 (her kopya +1).

S. Kızıl Monolit bu tur konuldu, bu tur 3 HP'yi mi kullanırım? · C. Hayır. Bir sonraki turdan itibaren geçerlidir.
...
S. Karmik Yansıma saldırıyı yansıttığında saldırganın Hizmetkâr Kalkanı uygulanır mı? · C. Evet. Yansıma saldırganın Kalkan Kuralı'na tabidir.
...
Kart toplamı — 16 Mühür + 24 Büyü + 16 Müdahale + 16 Hizmetkâr = 72.

Kapanış sırası — önce Mühür tetikleri, sonra el limiti kontrolü.
...
Sol basılı tutmak kartı sürükler. Sağ tık (veya F) çevirir. Ctrl + sürükle yığını taşır, Ctrl + G toplar, Ctrl + M karıştırır, Shift + A açar, Shift + K kapatır.
...
Herkes ayrıldığında oda kapanır. 'Odadan çık' tıklandığında yeni bağlantıyla taze bir oda açılır.
