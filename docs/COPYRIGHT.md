...
This document is not legal advice. The technical measures in `docs/SECURITY.md` are not a substitute for the legal steps above. A web client can never be fully tamper-proof; legal protection remains your strongest tool.
